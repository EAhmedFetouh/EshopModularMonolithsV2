...
namespace Ordering.Migrations
{
    ...
    [Migration("20251230100943_InitialCreate")]
            ...
            modelBuilder.Entity("Ordering.Orders.Models.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ShippingAdress", "Ordering.Orders.Models.Order.ShippingAdress#Address", b1 =>
                        {
                            b1.IsRequired();
